...
def runLightGBM():
    ...
    calculateMetrics("Light GBM", predict, y_test, 3)
...
def runExtensionCatboost():
    ...
    calculateMetrics("Proposed CatBoost", predict, y_test, 4)
...
def graph():
    ...
    df = pd.DataFrame([['Random Forest','Accuracy',accuracy[0]],['Random Forest','Precision',precision[0]],['Random Forest','Recall',recall[0]],['Random Forest','FSCORE',fscore[0]],
                       ...
                       ['Proposed Catboost','Accuracy',accuracy[4]],['Proposed Catboost','Precision',precision[4]],['Proposed Catboost','Recall',recall[4]],['Proposed Catboost','FSCORE',fscore[4]],
